...
class AllBoard: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.boarddb = BoardDB(board: "allboard", className: self.appDelegate.whichClass!, view: self.view, centerX: view.frame.size.width/2, centerY: view.frame.size.height/2, Flag: true)
    }
